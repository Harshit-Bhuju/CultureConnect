...
const DraftCourseModal = ({ course, onClose, onDraft }) => {
      ...
      <div className="bg-white rounded-lg max-w-md w-full shadow-xl">
        ...
        <div className="p-6">
          <p className="text-gray-700 mb-4">
            ...
            <span className="font-semibold">"{courseTitle}"</span> to drafts?
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-yellow-800 font-medium mb-2">
                  When you move this course to draft:
                </p>
                <ul className="text-sm text-yellow-700 space-y-1">
                  <li>• It will be hidden from all students</li>
                  <li>• Students cannot enroll in this course</li>
          ...
          <p className="text-sm text-gray-600">
            This course will remain in your drafts section until you publish it
            again.
          </p>
        </div>
