...
const CancelledEnrollments = ({
  ...
  const groupedEnrollments = useMemo(() => {
    const groups = {};
    cancelledEnrollments.forEach((item) => {
    ...
    return groups;
  }, [cancelledEnrollments, selectedPeriod]);
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Cancelled enrollments - {getPeriodLabel()}
            </p>
          </div>
      ...
      {cancelledEnrollments.length > 0 && (
        <div className="mt-6 mb-4 pt-4 border-t border-gray-200">
          <div className="text-center">
            ...
            <p className="text-xs text-gray-500 mt-1">Total Cancelled</p>
          </div>
        </div>
      )}
            ...
            <div key={date}>
              <div className="flex items-center mb-4">
                ...
                <div className="text-xs text-gray-500 ml-4">
                  {items.length} enrollment{items.length !== 1 ? "s" : ""}
                </div>
              </div>
...
export default CancelledEnrollments;
