                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <button
                        onClick={() =>
                          navigate(
                            `/teacher/courses/edit/${teacherId}/${id}?tab=curriculum`,
                          )
                        }
                    ...
                    {course.videos.length > 0 ? (
                      ...
                      <p className="text-gray-600 text-center py-8">
                        No videos added yet. Click "Edit Curriculum" to add
                        lessons.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      <p className="text-blue-800">
                        <strong>{course.enrolled_students}</strong> students are
                    ...
                    <p className="text-gray-600">
                      Detailed student list and progress tracking coming soon.
                    </p>
                  </div>
                )}
            ...
            <div className="sticky top-24 space-y-4">
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6 space-y-3">
                ...
                <div className="pt-3 border-t">
                  <button
                    onClick={
                      course.status === "Active" ? handleDraft : handlePublish
                    }
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6 space-y-4">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span
                      className={`font-medium ${course.status === "Active" ? "text-green-600" : "text-gray-600"}`}>
                      {course.status}
                    </span>
                  </div>
                  <div className="flex justify-between">
