...
import { Edit2, Trash2, AlertTriangle, Star, Upload } from "lucide-react";
import { BASE_URL } from "../../../Configs/ApiEndpoints";

// Draft Course Card Component - Visuals matched to CourseCard.jsx
const DraftCourseCard = ({ course, onEdit, onDelete, onView, onPublish }) => {
  ...
  return (
    <div
      ...
      <div className="absolute top-3 left-3 z-20 flex flex-col gap-1">
        {/* Draft Badge */}
        <span className="px-2 py-1 text-xs font-semibold rounded shadow-sm backdrop-blur-md bg-gray-100/90 text-gray-700">
          Draft
        </span>
      ...
      <div className="absolute top-3 right-3 z-20 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
        <button
          ...
          className="action-button bg-green-600 p-2 rounded-full shadow-md hover:bg-green-700 transition-colors border border-green-600"
          title="Publish">
