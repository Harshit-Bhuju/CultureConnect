      ...
      <div className="w-full max-w-6xl bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="grid grid-cols-3 gap-0">
          ...
          <div className="col-span-2 p-8 border-r border-gray-200">
            ...
            />
            <h1 className="text-3xl font-bold text-black mb-8">Payment Method</h1>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      <span className="text-black font-semibold text-lg block">eSewa</span>
                      <span className="text-gray-600 text-sm">Pay securely with eSewa wallet</span>
                    </div>
                  </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      <span className="text-black font-semibold text-lg block">Cash on Delivery</span>
                      <span className="text-gray-600 text-sm">Pay when you receive the order</span>
                    </div>
                  </div>
                  {selectedPayment === 'cod' && (
                    <Check className="text-black" size={28} />
            ...
            <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                <span className="font-semibold">Note:</span> Your order has been created and reserved.
          ...
          <div className="bg-gray-50 p-8">
                  ...
                  <div className="flex-1">
                    ...
                    {order.store_name && (
                      <div className="flex items-center gap-1 mt-1">
                        ...
                        <span className="text-xs text-gray-500">{order.store_name}</span>
                      </div>
                    )}
                  </div>
                </div>
            ...
            >
              {selectedPayment ? `Confirm & Pay Rs. ${total}` : 'Select Payment Method'}
            </button>
