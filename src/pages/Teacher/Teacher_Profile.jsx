          ...
          <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-amber-50 to-orange-50">
            <div className="text-center max-w-2xl p-12 bg-white rounded-3xl shadow-2xl">
              ...
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                Your teacher account is currently under review. This process usually takes up to 7 business days.
              </p>
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
                <p className="text-amber-800 font-medium mb-2">What happens next?</p>
                <p className="text-amber-700 text-sm">
                  Our team is carefully reviewing your application. Once approved, you'll receive an email notification and gain full access to create and manage your classes.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="w-[70%]">
                ...
                <div className="mt-3 space-y-2">
                  <div className="flex items-center gap-6 text-gray-500">
                    ...
                    <div>
                      <span>{classes.length} Published Class{classes.length !== 1 ? 'es' : ''}</span>
                    </div>
                  </div>
